...
#Solver parameters
span_y = 1 #mission span in y
tspan = (0.0, span_y * 31556926.0)

p = [G, M, c, S, AU, R, A, d, C_spec[1], C_spec[2],
    C_abs[1], C_abs[2], C_diff[1], C_diff[2], B_f, 
    K, h, n, ksi, m, I_s, u, C, C_a, C_n1_r, C_n2_r,
    C_r, C_n1_b, C_n2_b, C_b]
